...
5. In AthletiSync, open the `Google` page and enter these values in the `Google OAuth Configuration` section:

- `Google OAuth Client ID`
- `Google OAuth Client Secret`
- `Google OAuth Redirect URI`

6. Save the Google OAuth configuration on that page.
